...
REM ============================================================================
REM I&W Spreadsheet - Batch Script (Enterprise-hardened, original-style behavior)
...
REM ── Log files ──────────────────────────────────────────────────────────────
set "LOG_FILE=%LOG_DIR%\iw_spreadsheet_%TS%.log"
set "TEMP_OUT=%LOG_DIR%\temp_output_%TS%.log"

echo [%date% %time%] Log file: "%LOG_FILE%"
echo [%date% %time%] Starting I^&W Spreadsheet...> "%LOG_FILE%" 2>nul
...
echo.
echo ========================================================================================================
echo EXECUTING I^&W SPREADSHEET SCRIPT
echo ========================================================================================================

...
Import from here when a module needs a data location:
    ...
    from htoc_ml.core.paths import share_root, opdiv_obs_template, noi_forecast_save_dir
...
# Outside the data share (ThreatConnect pull project used by PRISM)
DEFAULT_TC_PROJECT_ROOT = (
    r"\\cscso1fsappv01\home\jaskew\HTOC\scripts\Data Movement\ThrearConnect-api-pull"
)

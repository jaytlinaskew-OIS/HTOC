...
REM ============================================================================
REM ThreatScoreIW multi-partner I&W workbook (htoc_ml)
...
REM Regenerate: py -3.13 -m htoc.datapipelines make-launcher --name threat-score-iw
REM ============================================================================

if not exist "C:\Temp" mkdir "C:\Temp" >nul 2>&1
echo [%date% %time%] bat started from: %~dp0 > "C:\Temp\threat_score_iw_debug.txt" 2>&1
...
set "LOG_DIR=%~dp0logs\threat_score_iw"
set "SUCCESS_MARKER=PIPELINE_OK"
set "PYTHONPATH=%HTOC_SHARE_ROOT%\Data_Analytics\threatconnect;%HTOC_ML_ROOT%\src;%PYTHONPATH%"
...
set "LOG_FILE=%LOG_DIR%\threat_score_iw_%TS%.log"
set "TEMP_OUT=%LOG_DIR%\temp_output_%TS%.log"

call :log START   ThreatScoreIW multi-partner I&W workbook (htoc_ml)
call :log CONFIG  Python: %PYTHON_EXE%
call :log CONFIG  Module: -m htoc.datapipelines.threat_score_iw
...
set "PKGS=pandas openpyxl pytz xlsxwriter"
...
call :log RUN     Launching -m htoc.datapipelines.threat_score_iw...
"%PYTHON_EXE%" -u -m htoc.datapipelines.threat_score_iw > "%TEMP_OUT%" 2>&1

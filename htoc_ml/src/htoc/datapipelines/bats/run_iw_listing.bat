...
REM ============================================================================
REM I&W master listing from PDFs
...
REM Regenerate: py -3.13 -m htoc.datapipelines make-launcher --name iw-listing
REM ============================================================================

if not exist "C:\Temp" mkdir "C:\Temp" >nul 2>&1
echo [%date% %time%] bat started from: %~dp0 > "C:\Temp\iw_listing_debug.txt" 2>&1
...
set "LOG_DIR=%~dp0logs\iw_listing"
...
set "LOG_FILE=%LOG_DIR%\iw_listing_%TS%.log"
set "TEMP_OUT=%LOG_DIR%\temp_output_%TS%.log"

call :log START   I&W master listing from PDFs
call :log CONFIG  Python: %PYTHON_EXE%
call :log CONFIG  Module: -m htoc.datapipelines iw-listing
...
set "PKGS=pandas openpyxl pdfplumber"
...
call :log RUN     Launching -m htoc.datapipelines iw-listing...
"%PYTHON_EXE%" -u -m htoc.datapipelines iw-listing > "%TEMP_OUT%" 2>&1

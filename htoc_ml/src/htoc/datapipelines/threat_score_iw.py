...
Uses shared code from ``htoc.core`` (paths, ThreatConnect, CLI exit). Run:
...
from htoc.core.threatconnect import ThreatConnectClient
from htoc.core.threatconnect_presets import INDICATOR_TYPES_WEEKLY, OWNERS_WEEKLY
